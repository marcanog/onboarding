<div class="flex justify-evenly">
    <div
        class="flex text-center gap-2 overflow-hidden justify-center py-32 md:px-16">
        <div class="shrink-0 grow-0 basis-auto lg:w-10/12 xl:w-9/10 leading-tight py-12 md:px-16">
            {{--Inicio Título--}}
            ...
            {{--Fin Título--}}
            {{--Inicio Formulario--}}
            <form class="min-w-full text-xl my-6 space-y-8 pb-2" wire:submit="save">
                ...
                <div class="grid md:grid-cols-3 sm:grid-cols-2 gap-8 group">
                    <div
            ...
            {{--Fin Formulario--}}
            {{--Inicio botones--}}
            <div class="flex mt-4 justify-between gap-8">
                <a wire:click="before()" type="button"
                   class="inline-flex justify-center items-center align-middle px-3 py-2 md:w-[31%] select-none cursor-pointer text-md border border-gray-900 focus:outline-none focus:border-blue-500 hover:border-blue-500 text-center align-middle rounded">
